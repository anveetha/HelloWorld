    ...
    if st.button("Search Events"):
        if keyword:
            ...
            if events:
                ...
                # Start a horizontal scrolling container
                st.markdown("""
                ...
                for event in events:
                    ...
                    st.markdown(f"""
                    <div style="flex: 0 0 auto; background-color: ; border-radius: 10px; 
                                padding: 20px; box-shadow: 0px 4px 10px rgba(0,0,0,0.1); width: 250px; 
                                text-align: center;">
                        <h4>{name}</h4>
                        <p>📍 {venue}</p>
                        <p>📅 {date}</p>
